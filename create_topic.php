        ...
        else
        {
            ...
            $sql = "INSERT INTO 
                        topics(topic_subject,
                               ...
                               topic_cat,
                               topic_by)
                   VALUES('" . mysqli_real_escape_string($link_db,$_POST['topic_subject']) . "',
                               NOW(),
                               " . mysqli_real_escape_string($link_db,$_POST['topic_cat']) . ",
                               " . $_SESSION['user_id'] . "
                               )";
            ...
            else
            {
                ...
                $topicid = mysqli_insert_id($link_db);
                ...
                $sql = "INSERT INTO
                            posts(post_content,
                                  ...
                                  post_by)
                        VALUES
                            ('" . mysqli_real_escape_string($link_db,$_POST['post_content']) . "',
                                  NOW(),
                                  " . $topicid . ",
                                  " . $_SESSION['user_id'] . "
                            )";
